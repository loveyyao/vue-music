<template>
  <div class="details playlist-details wh">
    <div class="details-top w">
      <div class="singer-img">
        <img v-lazy="song.img" alt="">
      </div>
      <div class="singer-name">
        <div><i class="el-icon-user"></i>{{song.user}}</div>
        <div class="song-details">{{description}}</div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    getPlaylist () {
      this.$axios.get('/playlist/detail', {id: this.song.id})
        .then((res) => {
